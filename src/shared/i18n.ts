...
export const I18N = {
  "zh-CN": {
    ...
    settings: {
      ...
      warnings: "分心",
      focusTime: "专注时长",
      distractionTime: "分心时长",
      focusDistribution: "专注分布",
      distractionDistribution: "分心分布",
      topFocusWindows: "专注最多窗口",
      topDistractionWindows: "分心最多窗口",
      topHours: "高峰时间段",
      noStatsYet: "还没有统计数据",
      minuteUnit: "分钟",
      secondUnit: "秒",
